...
async function run() {
  try {
    ...
    const loginRes = await axios.post('https://beautybeatsbymeerra-bdk7.onrender.com/api/auth/login', {
    ...
    console.log("3. Sending PUT request to production Render server...");
    const putRes = await axios.put('https://beautybeatsbymeerra-bdk7.onrender.com/api/website-content/6a5a77f0064e8fbb7204feec', form, {
      headers: {
        ...form.getHeaders(),
