...
const WebsiteContentSchema = new mongoose.Schema({
  ...
  type: {
    ...
    enum: [
      ...
      'CONTACT_INFO', 'SERVICES_PAGE_HEADER', 'SIGNATURE_SERVICES_HEADER', 'SIGNATURE_SERVICE_ITEM', 'CONTACT_ADDRESS', 'CONTACT_PHONE', 'CONTACT_EMAIL', 'SOCIAL_INSTAGRAM', 'SOCIAL_FACEBOOK', 'SOCIAL_TIKTOK'
    ],
