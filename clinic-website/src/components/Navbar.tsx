      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3 group">
          <div className="w-12 h-12 rounded-2xl overflow-hidden border-2 border-primary/20 group-hover:border-primary transition-all">
             <img src="https://res.cloudinary.com/dfcvnc77l/image/upload/v1784312818/beauty_beats_clinic/slvnisliku8ya8mhiyq3.jpg" alt="BeautyBeats Logo" className="w-full h-full object-cover" />
          </div>
