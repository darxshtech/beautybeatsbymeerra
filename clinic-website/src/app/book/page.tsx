        ...
        >
          {step === 0 && (
            <div className="space-y-8">
              ...
              {(() => {
                const displayMainCategories = Array.from(new Set(categories.map(c => c.mainCategory || 'General')));
          ...
          {step === 1 && (
            <div className="space-y-8">
              ...
              {(() => {
                const displayCategories = categories.filter(c => (c.mainCategory || 'General') === activeMainCategory).map(c => c.name);
            ...
            <div className="text-center py-12 space-y-8">
               ...
               <div>
                  ...
                  <p className="text-gray-500 text-lg">
                    {paymentMethod === "CASH" 
                      ? "Your appointment has been successfully booked. Pay at clinic on arrival."
               ...
               <div className="max-w-xs mx-auto p-6 bg-gray-50 rounded-3xl space-y-4 border border-gray-100">
                  ...
                  <div className="flex justify-between text-sm font-bold">
                     ...
                     <span className={cn("uppercase italic", paymentMethod === "CASH" ? "text-amber-600" : "text-green-600")}>
                        {paymentMethod === "CASH" ? "Pending (Pay at Clinic)" : "Paid"}
                     </span>
                  </div>
                  <div className="flex justify-between text-sm font-bold">
