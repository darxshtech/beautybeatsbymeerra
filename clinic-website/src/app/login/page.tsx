      ...
      >
        ...
        <header className="text-center mb-10">
           ...
           <p className="text-gray-500 font-bold text-sm mt-2">
             {isRegisterMode ? 'Induct yourself into the BeautyBeats enclave.' : 'Welcome back to the BeautyBeats enclave.'}
           </p>
        </header>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
           ...
           >
              ...
              {loading ? 'Processing...' : (isRegisterMode ? 'Establish Induction' : 'Sign Induction')}
           </button>
        </form>
